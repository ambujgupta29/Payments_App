          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 30),
                Text(
                  AppLocalizationText.phoneNumber,
                  style: Theme.of(context).textTheme.bodyMedium,
                ),
                TextField(
                  style: Theme.of(context).textTheme.titleMedium,
                ...
                buttonWidget(
                  ...
                  buttonText: AppLocalizationText.signup,
                ),
                SizedBox(height: 30),
                Center(
                  child: RichText(
                    text: TextSpan(
                      text: AppLocalizationText.alreadyHaveAnAccount,
                      style: Theme.of(context).textTheme.bodyMedium,
                      children: [
                        TextSpan(
                          text: ' ${AppLocalizationText.signin}',
                          style: Theme.of(context).textTheme.bodyMedium
                              ?.copyWith(
